...
clean:
	rm $(primary_files) main.o tests/performance.o main.exe test_chess-rules.exe test_bitboards.exe test_foundational.exe test_performance.exe test_time-consuming.exe
